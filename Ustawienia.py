...
class Ustawienia:
    def __init__(self, minLambda, maxLambda, seed, wylaczanie, liczbaSymulacji, dlugoscSymulacji, econ, ecoff, d, zadanie):
        ...
        self.wylaczanie = wylaczanie                        # tryb z wyłączeniami: False - bez wyłączeń; True - z wyłączeniami
        ...
        self.zadanie = zadanie                              # numer zadania do wykonania: {1, 2}
